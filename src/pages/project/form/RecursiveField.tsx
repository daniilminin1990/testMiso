...
export const RecursiveField: React.FC<RecursiveFieldProps> = memo((props) => {
  ...
  if (pd.type === FieldType.Hidden) return undefined;
  ...
  if (pd.isCollection && !inline) return <ArrayField fieldDescriptor={fd} inputId={inputId} />;

  if (pd.type === FieldType.Complex) return <ComplexField fieldDescriptor={fd} inputId={inputId} inline={!!inline} />;
